...
public class Missile {
	...
	public boolean hitTank(tank t) {
		if(t.getLive()&&this.getRec().intersects(t.getRec())&&t.good!=this.good) {
			if(t.isGood()) {
	...
	boolean hitTank(List<tank> enemys) {
	...
	boolean hitWall(Wall a) {
		if(this.getRec().intersects(a.getRec())&&!this.good) {
			live = false;
			return true;
			}
		return false;
